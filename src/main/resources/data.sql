...
INSERT INTO USER(username, password, email, enabled) values('wojtek', '$2a$10$1QnMN0yqRr22jw.mcuzZFeT1385sIuYiioL9BcTVhIHx2Rz2AB0ly', 'myemail@gmail.com', true);

INSERT INTO USER_ROLE(username, role) values('admin', 'ROLE_ADMIN');
INSERT INTO USER_ROLE(username, role) values('user', 'ROLE_USER');
INSERT INTO USER_ROLE(username, role) values('wojtek', 'ROLE_USER');
